...
#ifndef _UTP_SBE_SECURITYUPDATEACTION_CXX_H_
#define _UTP_SBE_SECURITYUPDATEACTION_CXX_H_
...
public:
    ...
    static SecurityUpdateAction::Value get(const char value)
    {
        switch (value)
        {
            ...
            case static_cast<char>(78): return NOCHANGE;
